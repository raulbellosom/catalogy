# Catalogy — Email Verification Function
...
| `EMAIL_SMTP_SECURE`                          | Usar TLS (true/false)            | `false`                 |
| `EMAIL_SMTP_USER`                            | Usuario SMTP                     |                         |
| `EMAIL_SMTP_PASS`                            | Contraseña SMTP                  |                         |
| `EMAIL_FROM_NAME`                            | Nombre del remitente             | `Catalogy`              |
| `EMAIL_FROM_ADDRESS`                         | Email del remitente              | `no-reply@...`          |
| `DEBUG`                                      | Activar logs detallados          | `true`                  |
...
- Al verificar, se actualiza `emailVerified: true` en el perfil del usuario.
- Si el email ya está verificado, no se envía nuevo correo.

...
export async function sendEmailWithNodemailer(to, subject, html) {
  ...
  const fromName = process.env.EMAIL_FROM_NAME || "Catalogy";
...
<head>
  ...
  <title>Verifica tu Email - Catalogy</title>
</head>
  ...
  <table role="presentation" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3);">
    <tr>
      <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center;">
        <h1 style="margin: 0; color: white; font-size: 28px; font-weight: 700;">📖 Catalogy</h1>
    ...
    <tr>
      <td style="padding: 40px 30px;">
        ...
        <p style="margin: 0 0 16px 0; color: #4a5568; font-size: 16px; line-height: 1.6;">
          Gracias por registrarte en Catalogy. Para completar tu registro y asegurar tu cuenta, por favor verifica tu dirección de correo electrónico.
        </p>
    ...
    <tr>
      <td style="background: #f7fafc; padding: 30px; text-align: center; border-top: 1px solid #e2e8f0;">
        <p style="margin: 0; color: #cbd5e0; font-size: 12px;">
          © ${new Date().getFullYear()} Catalogy. Todos los derechos reservados.
        </p>
      </td>
    </tr>
  </table>
